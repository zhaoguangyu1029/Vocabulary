...
public class DBOperator {
    ...
    private DBOperator(Context context,WordsDBHelper dbHelper){
        this.context = context;
        this.words_db_helper = dbHelper;
    }

    public static DBOperator getDBOperator(Context context,WordsDBHelper dbHelper){
     ...
     */
    public List<Word> query(String word_name){
        ...
        while (cursor.moveToNext()){
            ...
            word_item = new Word(str_word,str_meaning,str_sample);
